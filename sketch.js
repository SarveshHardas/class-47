...
function preload()
{
    ...
    lifeImg = loadImage("./image/heart.png");
...
function setup()
{
    ...
    player.addImage("moving",player1);
    player.addImage("walking",player2);
...
function press1()
{
    player.changeImage("moving",player1);
    gameState = 1;
    console.log("yess")
}
function press2()
{
    player.changeImage("walking",player2);
    gameState = 1;
    console.log("yess")
}
function press3()
